...
![Sell Physicals](/interface/assets/seller_list1.png)
...
![Create Products](/interface/assets/seller-create-product/seller-create-product-1button.png)
...
![Product description](/interface/assets/seller-create-product/seller-create-product-3info.png)
...
![Additional information](/interface/assets/seller-create-product/seller-create-product-4additional.png)
...
![Product Images](/interface/assets/seller-create-product/seller-create-product-5images.png)
...
![Core Terms of Sale](/interface/assets/seller-create-product/seller-create-product-6coreterms.png)
...
![Terms of Exchange](/interface/assets/seller-create-product/seller-create-product-8terms-exchange.png)
...
![Shipping Info](/interface/assets/seller-create-product/seller-create-product-9shipping.png)
...
![Additional information](/interface/assets/seller-create-product/seller-create-product-90additional.png)
...
![Initializing chat client](/interface/assets/seller-create-product/seller-create-product-91init-chat.png)
...
![Overview of new product](/interface/assets/seller-create-product/seller-create-product-92finish.png)
