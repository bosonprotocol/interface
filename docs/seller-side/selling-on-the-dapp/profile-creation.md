...
#### Fill-in the profile details <a href="#fill-in-the-profile-details" id="fill-in-the-profile-details"></a>
...
Note that XMTP is used for the initial communication of buyer's address and you are welcome to use it for all further comms as well. XMTP is a powerful web3 messaging protocol, read more about it [here](https://xmtp.org/).
...
#### Setting royalties <a href="#setting-royalties" id="setting-royalties"></a>
