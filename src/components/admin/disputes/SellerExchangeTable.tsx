...
import ExchangeStatuses, {
  Status,
  Statuses
} from "../../offer/ExchangeStatuses";
...
`;
export default function SellerExchangeTable({ data }: Props) {
    ...
    () =>
      data?.map((element) => {
        ...
        return {
          ...
          status: element && (
            <>
              {status !== ExchangesKit.ExtendedExchangeState.Expired &&
