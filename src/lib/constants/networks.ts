...
if (typeof INFURA_KEY === "undefined" || !INFURA_KEY) {
  throw new Error(
...
//   throw new Error(
//     `REACT_APP_BASE_GOERLI_RPC_URL must be a defined environment variable`
//   );
// }
// const QUICKNODE_BASE_RPC_URL = process.env.REACT_APP_BASE_MAINNET_RPC_URL;
// if (typeof QUICKNODE_BASE_RPC_URL === "undefined") {
//   throw new Error(
//     `REACT_APP_BASE_MAINNET_RPC_URL must be a defined environment variable`
//   );
// }
